  ...
  return (
    <div className="futuristic-loader">
      ...
      <div className="futuristic-loader__content">
        <p className="futuristic-loader__eyebrow">System initialization</p>

        <h1 className="futuristic-loader__title">Loading solar environment</h1>

        <div className="futuristic-loader__status">
          <span>Asset synchronization</span>

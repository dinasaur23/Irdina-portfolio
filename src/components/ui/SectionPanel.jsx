            ...
            {section.links.map((link) => {
                ...
                return (
                    <a
                        ...
                        className="group flex min-h-32 items-center justify-between rounded-2xl border border-white/10 bg-white/[0.025] px-7 py-6 transition duration-200 hover:border-white/20 hover:bg-white/[0.05]"
                    >
